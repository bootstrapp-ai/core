...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/reactive-view.js
import { LitElement } from "https://cdn.jsdelivr.net/gh/lit/dist@3.1.3/all/lit-all.min.js";

// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/theme.js
var FontWeight = {
  thin: "font-thin",
  // 200
...
var getElementTheme = (element, props) => {
  ...
  const classes = Object.keys(defaultElement).reduce((acc, attr) => {
    ...
    if (resolvedThemeValue)
      acc.push(resolvedThemeValue);
    return acc;
  }, []);
  if (defaultElement["_base"])
    classes.push(defaultElement["_base"]);
...
var BaseReactiveView = class _BaseReactiveView extends LitElement {
  ...
  handleServiceWorkerMessage(event3) {
    if (event3.data === "REQUEST_UPDATE") {
      this.requestUpdate();
    }
  }
  connectedCallback() {
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/reset.txt
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/app.package.js
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/chat.package.js
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/content.package.js
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/crud.package.js
...
var readFile = (file) => {
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (event3) => resolve(event3.target.result);
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/datetime.package.js
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/docs.package.js
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/form.package.js
import {
  css,
  html as html7,
  ifDefined
      ...
      render: function() {
        ...
        return href ? html7`
              <a
                class=${btnClass}
                href=${href}
                @click=${(event3) => click?.({ event: event3, props: this })}
              >
                <slot></slot>
              </a>
            ` : html7`
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/layout.package.js
import {
  css as css2,
  html as html8,
  staticHtml,
...
var droparea = {
  drop: function(event3) {
    event3.preventDefault();
    const children = Array.from(event3.currentTarget.children);
    currentPosition = children.indexOf(placeholderElement);
    removeExistingPlaceholder(event3.currentTarget);
  },
  dragleave: function(event3) {
    const dropareaBounds = event3.currentTarget.getBoundingClientRect();
    removeExistingPlaceholder(event3.currentTarget);
    if (this.vertical && event3.clientY === 0 || !this.vertical && event3.clientX === 0) {
      currentDroparea = null;
      currentDraggedItem = null;
      currentPosition = null;
    } else if (this.vertical && event3.clientY < dropareaBounds.top || !this.vertical && event3.clientX < dropareaBounds.left) {
      insertPlaceholder(event3.currentTarget, "start");
      currentPosition = 0;
    }
  },
  dragover: function(event3) {
    event3.preventDefault();
    const droparea2 = event3.currentTarget;
    ...
    const compareVal = this.vertical ? event3.clientY : event3.clientX;
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/navigation.package.js
  ...
  views: {
    ...
    "uix-tab": {
      ...
      firstUpdated: function() {
        const { onclose } = this;
        if (onclose) {
          this.shadowRoot.addEventListener("auxclick", function(event3) {
    ...
    "uix-context-menu": {
      ...
      documentClickHandler: function(event3) {
        if (!this.contains(event3.target) && this !== event3.target) {
          this.setOpen(false);
        }
      },
      escapeKeyHandler: function(event3) {
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/uix/ui.package.js
import {
  html as html10,
...
// node_modules/.pnpm/frontend@https+++codeload.github.com+bootstrapp-ai+frontend+tar.gz+0a8919315dee3fb2f04a60155f7ff94ca0373441/node_modules/frontend/index.js
var TYPE_MAP = {
  boolean: Boolean,
  number: Number,
  string: String,
...
// node_modules/.pnpm/helpers@https+++codeload.github.com+bootstrapp-ai+helpers+tar.gz+ff8e0ca2b12c3114151ef3df4c7a644c32b8fef4/node_modules/helpers/index.js
...
var dataChannel;
var startBackend = async ({ appId, models, baseModels, version }) => {
...
// src/index.js
var updateAllStyles = async (updateBefore = false, updateAfter = false) => {
  const result = await window.__unocss_runtime.update();
  const stylesheet = reset_default + result.css;
...
var startFrontend = ({ app, style }) => {
  const packages = [
    app,
    app_package_default,
    navigation_package_default,
    docs_package_default,
    chat_package_default,
    ui_package_default,
    crud_package_default,
    form_package_default,
    layout_package_default,
    content_package_default,
    datetime_package_default
  ];
  packages.reduce(
    (acc, pkg) => {
...
async function injectApp(app, style) {
  ...
  if (app.frontendOnly) {
    ...
    if (app.init)
      await app.init?.({ style, app });
    if (window.__unocss_runtime)
      window.__unocss_runtime.extractAll();
    if (window.__unocss_runtime)
      setTimeout(() => {
        const styleEl = document.createElement("style");
        styleEl.textContent = reset_default;
        document.head.append(styleEl);
        updateAllStyles();
      }, 500);
  } else {
    navigator.serviceWorker.addEventListener("message", async (event3) => {
      if (event3.data.type === "BACKEND_INITIALIZED") {
        {
          const { appId } = event3.data || {};
          ...
          if (event3.data) {
            if (navigator.storage && navigator.storage.persist) {
              ...
              console.log(
                granted ? "Storage will not be cleared except by explicit user action" : "Storage may be cleared by the UA under storage pressure."
              );
            }
            if (window.__unocss_runtime)
              setTimeout(() => {
...
var getStyle = () => {
  return [reset_default, decodeURIComponent(window.location.search.substring(1))].join(
    " "
  );
};
var injectStyle = (style) => {
...
var loadAppFromBlob = async ({ app, style }, frontendOnly) => {
...
var loadApp = ({ app, style }) => {
  if (!app)
    return console.error("DEBUG: App not found.");
  if (!isValidApp(app))
    return console.error("DEBUG: App is invalid.", { app });
  if ("serviceWorker" in navigator) {
    navigator.serviceWorker.register("/service-worker.js", { scope: "/" }).then((registration) => {
      ...
      setTimeout(() => {
        if (registration.active) {
          if (!app.frontendOnly) {
            ...
            let appId = urlParams.get("appId") || localStorage.getItem("appId");
      ...
      (error) => console.error("Error loading service-worker", { error })
    );
  }
};
var environmentStrategies = {
  production: async () => {
    ...
    if (style)
      injectStyle(style);
    if (app)
      await loadAppFromBlob({ app, style });
  },
  staging: async () => {
  ...
  preview: async () => {
    const stagingLoadApp = async () => {
      ...
      const app = getUrlBlob();
      if (app)
        await loadAppFromBlob({ app }, true);
    };
    window.addEventListener("hashchange", () => {
      window.location.reload();
    });
  ...
  development: async () => {
    ...
    ws.addEventListener("message", (event3) => {
      if (event3.data === "refresh") {
...
var bootstrap = async (environment = "development") => {
